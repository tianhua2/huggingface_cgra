...
class MSClapAudioModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class MSClapAudioModelWithProjection(metaclass=DummyObject):
    _backends = ["torch"]
...
class MSClapPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
